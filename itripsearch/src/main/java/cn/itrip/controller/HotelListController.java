...
import cn.itrip.commons.DtoUtil;
...
public class HotelListController {
    ...
    @ApiOperation(value = "查询酒店分页", httpMethod = "POST",
            ...
            "<p>20001: 系统异常,获取失败</p>" +
            "<p>20002: 目的地不能为空</p>")
    @RequestMapping(value = "/serachItripHotelPage",produces ="application/json",method = RequestMethod.POST)
    @ResponseBody
    ...
    @ResponseBody
    public Dto<Page<ItripHotelVO>> serachItripHotelListByHotCity(@RequestBody SearchHotCityVO vo) throws Exception{
